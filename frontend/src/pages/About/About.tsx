        ...
        <div className="about-container">
          <div className="about-details-container">
            <div className="text-container">
              <p>
                Hello, I am a graduate student at Youngstown State University,
                holding a B.Sc. in Information Technology with a specialization
              ...
              <p>
                Beyond coding, I find joy in taking walks in the park,
                appreciating the wonders of nature, exploring different
                cuisines, and playing video games whenever I have free time.
              </p>
            </div>
          </div>
        </div>
